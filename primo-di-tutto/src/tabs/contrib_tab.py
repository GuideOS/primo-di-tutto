...
class ContribTab(ttk.Frame):
    def __init__(self, master):
        ...
        text_box.insert(
            tk.END, "@Fhyrst @Bulvai @DenalB @evilware666 @GF-S15 @Gonzo-3004 @Hammer20l @harihegen @kim88 @KTT73 @maik3531 @Mastertac @Nightworker @Perval @Stardenver @Stephan @StephanR @stryvyr @Toadie"
        )
