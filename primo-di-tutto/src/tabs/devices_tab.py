...
class DevicesTab(ttk.Frame):
    def __init__(self, master):
        ...
        # Scrollbar
        usb_scrollbar = ttk.Scrollbar(usb_tree_frame, orient=VERTICAL, command=self.usb_tree.yview)
        ...
        refresh_btn = ttk.Button(
            button_frame,
            text="Aktualisieren",
            command=self.refresh_all_devices
        )
        refresh_btn.pack()
        ...
        try:
            ...
            for line in lines:
                ...
                try:
                    ...
                    dev_num = bus_dev_part.split('Device')[1].strip().rstrip(':')  # Remove trailing colon
                except:
                    continue
        ...
        try:
            ...
            for line in lines:
                ...
                if len(parts) >= 3:
                    ...
                    device_name = parts[2]  # Advanced Micro Devices, Inc. [AMD] Starship/Matisse Root Complex
    ...
    def refresh_pci_devices(self):
        ...
        for device in devices:
            self.pci_tree.insert(
                "",
                END,
                values=(device['slot'], device['type'])
            )
